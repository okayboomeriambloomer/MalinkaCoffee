...
@Entity
@Table(schema = "coffee", name = "upcoming_order")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class UpcomingOrder {
    ...
    public UpcomingOrder(Person person, CoffeePoint coffeePoint, Drink drink, Cake cake, Double orderAmount, LocalDateTime date) {
        this.person = person;
